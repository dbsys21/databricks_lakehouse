...
-- MAGIC 
-- MAGIC <img src="https://github.com/dbsys21/databricks-demo/raw/main/product_demos/uc/UC-FK-PK-crop.png" style="float:right; margin:10px 0px 0px 10px" width="700"/>
-- MAGIC 
-- MAGIC 
-- MAGIC 
...
-- MAGIC ## Use case
-- MAGIC 
-- MAGIC <img src="https://github.com/dbsys21/databricks-demo/raw/main/product_demos/uc/UC-star-schema.png" style="float:right; margin:10px 0px 0px 10px" width="700"/>
-- MAGIC 
...
-- MAGIC # Summary
-- MAGIC 
-- MAGIC <img src="https://github.com/dbsys21/databricks-demo/raw/main/product_demos/uc/UC-star-schema.png" style="float:right; margin-left:10px" width="900"/>
-- MAGIC 
